...
"    Modified: by hariton <hmizgir@gmail.com>
" Last Change: 1 Feb 2010
...
" Colors for the User Interface.
    ...
    exec "hi lCursor        cterm=BOLD   ctermfg=0   ctermbg=14"
    ...
    exec "hi Todo         cterm=bold ctermfg=255 ctermbg=167"
    ...
    exec "hi IncSearch      cterm=NONE    ctermfg=0   ctermbg=25"
    exec "hi Search         term=standout ctermfg=0   ctermbg=11"
    ...
    exec "hi Pmenu          cterm=bold   ctermfg=230   ctermbg=60"
    exec "hi PmenuSel       cterm=bold   ctermfg=0     ctermbg=7"
    exec "hi PmenuSbar      cterm=bold   ctermfg=0     ctermbg=248"
    exec "hi MatchParen     cterm=bold   ctermfg=253   ctermbg=24"
    ...
    exec "hi DiffChange                  ctermfg=255  ctermbg=60"
    ...
    exec "hi SpellBad  term=underline ctermfg=216 ctermbg=NONE guifg=#ffaf87"
    exec "hi SpellCap term=underline,bold ctermfg=189 ctermbg=NONE guifg=#d7d7ff"
    exec "hi SpellRare term=underline ctermfg=99 ctermbg=NONE guifg=#875fff"
    exec "hi SpellLocal term=underline ctermfg=179 ctermbg=NONE guifg=#d7af5f"

    " Colors for Syntax Highlighting.
    if exists("g:gardener_light_comments")
        " exec "hi Comment        cterm=NONE   ctermfg=253   ctermbg=60"
        exec "hi Comment    ctermfg=7 ctermbg=236"
    else
...
let g:colors_name = "gardener-hariton"
let colors_name   = "gardener-hariton"
